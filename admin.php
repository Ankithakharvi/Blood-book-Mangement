...
if(isset($_POST['signup'])){
	...
	if(!empty($name) && !empty($email) && !empty($password) && !empty($confirm))
	{
		...
		$Query = $con->query("INSERT INTO login (name,email,password,usertype) VALUES ('$name','$email','$password','user')");
		if($Query)
		{
			// header("location:log.php?signup_success='Your acccount is successfully created!'");
     // header("Location: log.php?signup_success='Your account is successfully created!'");
    //  echo "<script>alert('registered successfully. now please log in')</script>";
     echo "<script>
